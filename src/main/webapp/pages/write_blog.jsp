...
<div class="container">
    ...
    <div style="background-color: #FFFFFF; padding: 10px 15px 15px 15px;">
        <h2 class="text-center" style="margin-bottom: 15px">撰写博客</h2>
        <div class="form-group">
            <label for="blog-title" class="control-label">标题</label>
            <input type="text" class="form-control" id="blog-title" value="${requestScope.blog.title == null ? "" : requestScope.blog.title}">
        </div>
        <div class="form-group">
            <label for="blog-type" class="control-label">类型</label>
            <input type="text" class="form-control" id="blog-type" value="${requestScope.blog.type == null ? "" : requestScope.blog.type}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <button class="btn btn-primary" style="width: 35%" id="post-blog-button" data-loading-text="正在保存">发布</button>
    ...
    layui.use(['layer', 'form'], function () {
        ...
        postOrSave = function (status) {
            ...
            $.ajax({
                ...
                type: 'post',
                data: {'title': title, 'content': content, 'type': type, 'status': status},
